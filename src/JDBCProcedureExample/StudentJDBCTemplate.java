...
public class StudentJDBCTemplate implements StudentDAO{
	...
	public void setDataSource(DataSource ds) {
		...
		this.jdbcCall = new SimpleJdbcCall(dataSource).withFunctionName("getRecord");
	}
	...
	public Student getStudent(Integer id) {
		// student1 vẫn có theerg get bằng jdbcTemplateObject? 
		String SQL = "select * from Student where id = ?";
		Student student1 = jdbcTemplateObject.queryForObject
				(SQL, new Object[] {id},new StudentMapper());
		System.out.println("Object received from jdbcTemplate: " + student1.getName() + " " + student1.getAge());
		// Thực hiện bằng function ( procedure)
		// TODO: Tại sao chỗ này LỖI??????
